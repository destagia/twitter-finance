@REM twitter-finance launcher script
@REM
@REM Environment:
@REM JAVA_HOME - location of a JDK home dir (optional if java on path)
@REM CFG_OPTS  - JVM options (optional)
@REM Configuration:
@REM TWITTER_FINANCE_config.txt found in the TWITTER_FINANCE_HOME.
@setlocal enabledelayedexpansion

@echo off
if "%TWITTER_FINANCE_HOME%"=="" set "TWITTER_FINANCE_HOME=%~dp0\\.."
set ERROR_CODE=0

set "APP_LIB_DIR=%TWITTER_FINANCE_HOME%\lib\"
...
set "CFG_FILE=%TWITTER_FINANCE_HOME%\TWITTER_FINANCE_config.txt"
set CFG_OPTS=
if exist %CFG_FILE% (
...
if "%JAVAOK%"=="false" (
  ...
  echo and download a valid Java JDK and install before running twitter-finance.
  echo.
